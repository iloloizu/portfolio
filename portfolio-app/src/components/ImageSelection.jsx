    ...
    return (
        <div className="ImageSelection"><br/>
            ...
            <div className="about-info"><br/>
                ...
                <br/> <a href='https://drive.google.com/file/d/1QzcREXV8AaufL-Um-geL6Q4WFE6bZrkm/view?usp=sharing' target="_blank" rel="noreferrer">
                <button className="btn">Download Résumé</button></a>
                <br/> <a href='https://drive.google.com/file/d/1NBmiCO9gu5XBVaNNbOQutQlVzkdq8iXZ/view?usp=sharing' target="_blank" rel="noreferrer">
